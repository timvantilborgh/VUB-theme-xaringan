---
title: "VUB theme for xaringan presentations"
subtitle: “An example"
author: "Tim Vantilborgh"
institute: "Vrije Universiteit Brussel"
date: "2020/12/13 (updated: `r Sys.Date()`)"
output:
  xaringan::moon_reader:
    css: ["VUB-theme.css", "VUB-fonts.css"]
    lib_dir: libs
    nature:
...
- This example presentation demonstrates what the VUB theme looks like
- This theme is based on the Rutgers theme for xaringan
- It uses the fonts, logo, and colour scheme of the VUB style
- Feel free to use this theme, share it, or adapt it
- If you have suggestions for further improvements, create an issue on github

---
class: inverse, center, middle

# You can create inverse slide layouts
